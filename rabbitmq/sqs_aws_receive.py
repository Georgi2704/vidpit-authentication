...
#         payload = {"correlation_id": f"{correlation_id}", "user": f"{vars(user)}"}
#     except:
#         payload = {"correlation_id": f"{correlation_id}", "user": "403"}
#     # Delete received message from queue
#     sqs.delete_message(QueueUrl=queue_jwt, ReceiptHandle=receipt_handle)
#     print("Received and deleted message: %s" % message)
#     payload2 = json.dumps(payload)
#     sqs.send_message(QueueUrl=queue_decoded, MessageBody=payload2)
#
#
